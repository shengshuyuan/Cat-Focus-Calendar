...
| Cat Focus Calendar pages / layers / month navigation / SoftAP provisioning | `docs/cat-focus-calendar.md`, `main/clock_app.c` |
| Pixel clock / Chinese UI / custom LVGL fonts | `docs/development/engineering/coding-conventions.md`, `docs/pixel-clock-v1.md`, `main/fonts/folotoy_font.c` |
